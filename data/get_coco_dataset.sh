...
# Download Images
wget -c "https://pjreddie.com/media/files/train2017.zip" --header "Referer: pjreddie.com"
wget -c "https://pjreddie.com/media/files/val2017.zip" --header "Referer: pjreddie.com"
...
wget -c "https://pjreddie.com/media/files/instances_train-val2017.zip" --header "Referer: pjreddie.com"
...
tar xzf labels.tgz
unzip -q instances_train-val2017.zip
